...
// Note that TableSetupScrollFreeze() enforce a display order range for frozen
// columns. So reordering a column across the frozen column barrier is illegal
// and will be undone.
void ImGui::TableSetColumnDisplayOrder(ImGuiTable *table, int column_n,
  ...
  // FIXME-OPT: If this is called multiple times we'd effectively have a O(N^2)
  // thing going on.
  for (int n = 0; n < table->ColumnsCount; n++)
